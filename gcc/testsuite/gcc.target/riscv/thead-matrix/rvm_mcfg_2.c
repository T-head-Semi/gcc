...
void foo2 (int32_t* base, int stride, mint32_t *temp1, mint32_t *temp2, uint16_t msize_m, uint16_t msize_k)
{
  *temp1 = __riscv_th_mld(base, stride, msize_m, msize_k);
  *temp2 = __riscv_th_mld(base, stride, msize_m, msize_k);
}

void foo3 (int32_t* base, int stride, mint32_t *temp1, mint32_t *temp2, uint16_t msize_m, uint16_t msize_k)
{
  *temp1 = __riscv_th_mld(base, stride, msize_m, msize_k);
  *temp2 = __riscv_th_mld(base, stride, msize_m, msize_k * 2);
}

void foo5 (int32_t* base, int stride, mint32_t *temp1, mint32_t *temp2, uint16_t msize_m, uint16_t msize_k)
{
  *temp1 = __riscv_th_mld(base, stride, msize_m, msize_k);
...
void foo6 (mfloat32_t *dest1, mfloat32_t *dest2, mfloat32_t src1, mfloat32_t src2, mrow_t row1, mrow_t row2, mcol_t col, uint16_t msize_k)
{
...
/* { dg-final { scan-assembler-times "mcfgk\t" 9 } } */

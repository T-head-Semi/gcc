...
/* { dg-final { scan-assembler-times "msra\\.\[sd\]\\.mm\tm\[0-9\]+" 2 } } */
/* { dg-final { scan-assembler-times "msra\\.\[sd\]\\.mv.x\tm\[0-9\]+" 2 } } */
/* { dg-final { scan-assembler-times "msra\\.\[sd\]\\.mx\tm\[0-9\]+" 2 } } */

/* { dg-final { scan-assembler-times "mn4clip\\.\[sd\]\\.mm\tm\[0-9\]+" 2 } } */
/* { dg-final { scan-assembler-times "mn4clip\\.\[sd\]\\.mv.x\tm\[0-9\]+" 2 } } */
/* { dg-final { scan-assembler-times "mn4clip\\.\[sd\]\\.mx\tm\[0-9\]+" 2 } } */

/* { dg-final { scan-assembler-times "mn4clipu\\.\[sd\]\\.mm\tm\[0-9\]+" 2 } } */
/* { dg-final { scan-assembler-times "mn4clipu\\.\[sd\]\\.mv.x\tm\[0-9\]+" 2 } } */
/* { dg-final { scan-assembler-times "mn4clipu\\.\[sd\]\\.mx\tm\[0-9\]+" 2 } } */

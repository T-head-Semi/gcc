/* { dg-do link } */
/* { dg-options "-mcpu=c907fd-rv32" } */
/* c907 = rv32imafdc_zicbom_zicbop_zicboz_zicond_zihintntl_zihintpause_zawrs_zfa_zfbfmin_zfh_zcb_zba_zbb_zbc_zbs_svinval_svnapot_svpbmt_xtheadc -mabi=ilp32d */

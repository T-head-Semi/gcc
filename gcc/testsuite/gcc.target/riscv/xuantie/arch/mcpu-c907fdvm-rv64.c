/* { dg-do link } */
/* { dg-options "-mcpu=c907fdvm-rv64" } */
/* c907 = rv64imafdcv_zicbom_zicbop_zicboz_zicond_zihintntl_zihintpause_zawrs_zfa_zfbfmin_zfh_zcb_zba_zbb_zbc_zbs_zvfbfmin_zvfbfwma_svinval_svnapot_svpbmt_xtheadc_xtheadmatrix_xtheadvdot -mabi=lp64d */

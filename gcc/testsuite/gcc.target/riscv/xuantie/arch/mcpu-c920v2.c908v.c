/* { dg-do link } */
/* { dg-options "-mcpu=c920v2.c908v" } */
/* c920v2.c908v =rv64imafdcv_zicbom_zicbop_zicboz_zihintpause_zfh_zba_zbb_zbc_zbs_svinval_svnapot_svpbmt_xtheadc_xtheadvdot -mabi=lp64d */

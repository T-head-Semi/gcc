/* { dg-do link } */
/* { dg-options "-mcpu=c907-rv32" } */
/* c907 = rv32imac_zicbom_zicbop_zicboz_zicond_zihintntl_zihintpause_zawrs_zcb_zba_zbb_zbc_zbs_svinval_svnapot_svpbmt_xtheadc -mabi=ilp32 */

...
void test (uint64_t value)
{
  ...
  mint64_t ans = __riscv_th_msra_mx (src, value, MROW, MCOL);
  print_data (ans);        
}
...
/* { dg-output "0x8000000080 0x8000000081 0x8000000081 0x8000000082 0x8000000082 0x8000000083 0x8000000083 0x8000000084 \r\n" } */
